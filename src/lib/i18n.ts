...
export const messages: Record<Locale, Record<string, string>> = {
  es: {
    ...
    // ---- Invitations manager ----
    "inv.create": "+ Crear invitación",
    "inv.titleLabel": "Título",
    "inv.titlePlaceholder": "Ej.: Familia García",
    "inv.guestsLabel": "Invitados incluidos",
    "inv.noGuests": "Aún no hay invitados. Añade invitados en el panel de invitados.",
    "inv.empty": "Aún no hay invitaciones. Crea la primera para generar sus códigos QR.",
    "inv.save": "Crear invitación",
    "inv.delete": "Eliminar invitación",
    "inv.confirmDelete": "¿Eliminar esta invitación? Los invitados se quedarán en el panel.",
    "inv.qrDownload": "Descargar QR",
    "inv.errTitle": "Escribe un título para la invitación.",
    "inv.errNoGuests": "Elige al menos un invitado.",
    "inv.errGuest": "Alguno de los invitados elegidos ya no existe.",
    "inv.errSave": "No se pudo crear la invitación. Inténtalo de nuevo.",
    "inv.errNetwork": "Error de red: no se pudo crear la invitación.",
    "guest.edit": "Editar",
  ...
  en: {
    ...
    "inv.titlePlaceholder": "E.g. García family",
    "inv.guestsLabel": "Included guests",
    "inv.noGuests": "No guests yet. Add guests from the guest panel first.",
    "inv.empty": "No invitations yet. Create the first one to generate its QR codes.",
    "inv.save": "Create invitation",
    "inv.delete": "Delete invitation",
    "inv.confirmDelete": "Delete this invitation? The guests will stay in the panel.",
    "inv.qrDownload": "Download QR",
    "inv.errTitle": "Give the invitation a title.",
    "inv.errNoGuests": "Pick at least one guest.",
    "inv.errGuest": "One of the chosen guests no longer exists.",
    "inv.errSave": "Could not create the invitation. Try again.",
    "inv.errNetwork": "Network error: could not create the invitation.",
    "guest.edit": "Edit",
