...
export const messages: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "dash.guestsAdults": "Adultos",
    "dash.guestsChildren": "Niños",
    "dash.tables": "Mesas",
    ...
    "guest.allAllergies": "Todas las alergias",
    "guest.allergyCustom": "Personalizada…",
    ...
    "invman.sendInvitation": "Enviar invitación",
    "invman.whatsappMessage": "Te invitamos a nuestra boda 💍 {url}",
    "invman.sentLabel": "Invitación enviada",
    "invman.sentYes": "Sí",
    "invman.sentNo": "No",
    "invman.sentAria": "Marcar invitación como enviada",
    ...
    "invman.plusOneTitle": "Acompañantes",
    "invman.plusOnePlaceholder": "Nombre del acompañante",
    "guest.edit": "Editar",
    ...
    "seating.guestsTitle": "Invitados en esta mesa",
    "seating.decorationTitle": "Decoraciones adjuntas",
    "seating.deleteTable": "Eliminar esta mesa",
    ...
    "tpl.mapUrlLabel": "Mapa (enlace de Google Maps)",
    "tpl.mapUrlPlaceholder": "https://maps.google.com/maps?q=...&output=embed",
    "tpl.mapUrlHelp": "Pega el enlace del mapa para incrustarlo debajo de las indicaciones.",
    ...
    "inv.envelopeWelcome": "Bienvenidos",
    "inv.envelopeHint": "Haz clic en el sello para empezar",
    "inv.envelopeOpenAria": "Abrir la invitación",
    "inv.plusOneBring": "Voy con acompañante",
    "inv.plusOneNoBring": "Voy solo/a",
    "inv.adultsSection": "Adultos",
    "inv.childrenSection": "Niños",
    "inv.child": "Niño/a",
  ...
  en: {
    ...
    "dash.guestsAdults": "Adults",
    "dash.guestsChildren": "Children",
    "dash.tables": "Tables",
    ...
    "guest.allAllergies": "All allergies",
    "guest.allergyCustom": "Custom…",
    ...
    "invman.sendInvitation": "Send invitation",
    "invman.whatsappMessage": "You're invited to our wedding 💍 {url}",
    "invman.sentLabel": "Invitation sent",
    "invman.sentYes": "Yes",
    "invman.sentNo": "No",
    "invman.sentAria": "Mark invitation as sent",
    ...
    "invman.cancel": "Close",
    "invman.plusOneTitle": "Plus ones",
    "invman.plusOnePlaceholder": "Plus one name",
    "guest.edit": "Edit",
    ...
    "seating.guestsTitle": "Guests at this table",
    "seating.decorationTitle": "Attached decorations",
    "seating.deleteTable": "Delete this table",
    ...
    "tpl.mapUrlLabel": "Map (Google Maps link)",
    "tpl.mapUrlPlaceholder": "https://maps.google.com/maps?q=...&output=embed",
    "tpl.mapUrlHelp": "Paste the map link to embed it below the directions.",
    ...
    "inv.envelopeWelcome": "Welcome",
    "inv.envelopeHint": "Tap the seal to begin",
    "inv.envelopeOpenAria": "Open the invitation",
    "inv.plusOneBring": "I'm bringing a plus one",
    "inv.plusOneNoBring": "I'm coming alone",
    "inv.adultsSection": "Adults",
    "inv.childrenSection": "Children",
    "inv.child": "Child",
